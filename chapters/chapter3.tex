...
%		\subsection{Dataset Construction and Analysis Methods \textcolor{red}{ 3 pages}}
	...
	\section{Test Beam Characterisation of \textit{ATTRACT} Prototypes}
		...
		\begin{table}[h]
			...
			\begin{tabular}{c|cccc|l}
				\cline{1-5}
				\multicolumn{5}{|c|}{\textbf{Efficiency measured at HV = 120 V}}                                                                                                                         & \multicolumn{1}{c}{\textbf{}} \\ \cline{1-5}
		...
		\begin{table}[h]
			...
			\begin{tabular}{c|ccccc|l}
				\cline{1-6}
				\multicolumn{6}{|c|}{\textbf{Efficiency measured at \power = \SI{1.8}{\watt/\centi\meter^2}}}                                                                                                                         & \multicolumn{1}{c}{\textbf{}} \\ \cline{1-6}
	...
	The results are presented for the prototype as a function of the power density (\power), as a function of the High Voltage (HV) bias given to the substrate and as a function of the particle's position within the pixel. The following section refers to the work published in early 2023 in the Journal of Instrumentation (JINST) \cite{MONOLITH_proto2_20ps}.
		...
		\begin{table}[h]
			...
			\cline{1-5}
			\cline{1-5}
			\ \textbf{\power [W/cm$^2$]} &  \textbf{\noise [mV]} & \textbf{$\sigma_{\text{scope}}$ [mV]} & \textbf{$A_q$ [mV/fC]} & \textbf{ENC [electrons]} \\
			\cline{1-5}
		...
		\begin{table}[h]
			...
			\begin{tabular}{|c|c|c|}
			\cline{1-3}
			 \textbf{\power [W/cm$^2$]} & ~~~~~~~\textbf{$HV$~[\si{V}]}~~~~~~~  & \textbf{Average efficiency [\%]} \\
			\cline{1-3}
		...
		\begin{table}[h]
			...
			\begin{tabular}{|c|c|c|}
			\cline{1-3}
			\multicolumn{3}{|c|}{\textbf{DUT operated at  $ HV = \SI{200}{\volt} $ and $V_{\it th} = 7 \sigma_V$}} \\ 
			\cline{1-3}
	...
	The results are presented for the prototypes as a function of the power density (\power), as a function of the High Voltage (HV) bias given to the substrate and as a function of the particle's position within the pixel and are compared with the non-irradiated samples. The following section refers to the work published in June 2024 in the Journal of Instrumentation (JINST) \cite{Moretti_irradiated}.
		...
		\begin{table}[h]
			...
			\cline{1-8}
			\begin{tabular}{c} \textbf{Proton Fluence} \\ \ \textbf{[1 MeV n$_{\text{eq}}$/cm$^2$]} \end{tabular} & \multicolumn{3}{c|}{\textbf{\power~ [W/cm$^2$]}}  & \multicolumn{4}{c|}{\textbf{High Voltage [V]}} \\
			\cline{1-8}
		...
		\begin{table}[h]
			...
			\cline{1-5}
			\cline{1-5}
			\begin{tabular}{c} \textbf{Proton Fluence} \\ \ \textbf{[1 MeV n$_{\text{eq}}$/cm$^2$]} \end{tabular} & \begin{tabular}{c}\textbf{\power}~ \\ \ \textbf{[W/cm$^2$]} \end{tabular} & \begin{tabular}{c} \textbf{High} \\ \textbf{Voltage} \\ \ \textbf{[V]} \end{tabular} & \begin{tabular}{c} \textbf{Detection} \\ \textbf{Efficiency} \\ \ [\%]\end{tabular} & \begin{tabular}{c} \textbf{Time} \\ \textbf{Resolution} \\  \ \textbf{[ps]}\end{tabular} \\
			\cline{1-5}
		...
		\begin{table}[h]
			...
			\cline{1-4}
			\multirow{2}{*}{\begin{tabular}{c}\textbf{Proton Fluence} \\ \ \textbf{[1 MeV n$_{\text{eq}}$/cm$^2$]}\end{tabular} } & \multicolumn{2}{c|}{\begin{tabular}{c}  \textbf{Time Resolution [ps]} \end{tabular}} & \multirow{2}{*}{\begin{tabular}{c} \textbf{Ratio}  \end{tabular}} \\ \cline{2-3}
