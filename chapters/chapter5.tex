...
% TODO change the scale of the axis and title to match the ones that are bigger in the plots below. 
		\begin{figure}[h]
			\centering
...
% TODO plot with cut on distance 
% TODO empty reach plot, and then with the contours and explain procedure with simulations with a short description of the PS at the time 6 layers with 1.1X0 of tungsten in front of each Si layer, pixel pitch of approximately 100µm and so separation of minimum 200µm to distinguish the photons. 
