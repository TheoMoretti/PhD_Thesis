...
\definecolor{darkred}{HTML}{9B0101}
\usepackage{multirow}      
...
% TODO ALL: Have the indentation for the captions of the figures as well so that it fills the full space and si not centred as it is now (==ugly).
% TODO ALL: Check how to cite unpublished papers such as: FASER_Final_ASIC_UniGe 
% TODO ALL: Check that all the captions specify the colors and the marker type of the plots 
% TODO LAST: Check format of bibliography and uniformise it
